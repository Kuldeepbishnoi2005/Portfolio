...
export const projects: Project[] = [
  {
    ...
    image: 'https://qaekqlqtkygzzfkcompg.supabase.co/storage/v1/object/sign/portfolio.img/loginpage.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InN0b3JhZ2UtdXJsLXNpZ25pbmcta2V5XzllMzhjZDVhLTI2MTgtNDM0NS1hYzRmLTkwMzY4NGU2MGYwOCJ9.eyJ1cmwiOiJwb3J0Zm9saW8uaW1nL2xvZ2lucGFnZS5wbmciLCJpYXQiOjE3NDgxOTUxNTQsImV4cCI6NjYzOTY5OTUxNTR9.TJRmr-EWloQjjpDeR8SyUZGYaGNXIcxQQXB2Tp5BcIQ',
  ...
  },
  {
    ...
    longDescription: 'AudioX – A Smart and User-Friendly Music Platform. AudioX is a simple yet powerful music streaming website that offers a wide range of songs with easy-to-use playback controls, playlists, and a responsive design. This project highlights my passion for music and showcases my skills in web development. In the future, I plan to add more features like custom playlist creation, API integration, and improved functionality to make it even better for users.',
     image: 'https://qaekqlqtkygzzfkcompg.supabase.co/storage/v1/object/sign/portfolio.img/AudioX.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InN0b3JhZ2UtdXJsLXNpZ25pbmcta2V5XzllMzhjZDVhLTI2MTgtNDM0NS1hYzRmLTkwMzY4NGU2MGYwOCJ9.eyJ1cmwiOiJwb3J0Zm9saW8uaW1nL0F1ZGlvWC5wbmciLCJpYXQiOjE3NDgxOTYyMzEsImV4cCI6NjYzOTY5OTYyMzF9.3mzcGl1mkOWPgRLtaaQcBMJBQGMPFI9waVsNbMn8XII',
